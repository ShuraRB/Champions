<?php 
    ...
    class Perfil_Usuario extends BaseController{
        ...
        public function __construct(){
            ...
            if (acceso_usuario(TAREA_PERFIL)) {
        ...
        public function index(){
            ...
            if($this->permitido){
                return $this->crear_vista("panel/perfil_usuario", $this->cargar_datos());
