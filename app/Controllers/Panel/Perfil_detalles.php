<?php 
    ...
    class Perfil_detalles extends BaseController{
        ...
        public function __construct(){
            ...
            if (acceso_usuario(TAREA_PERFI_DETALLES)) {
                $session->tarea_actual = TAREA_PERFIL_DETALLES;
            }//end if 
            else{
        ...
        public function index($id_usuario = NULL){
            ...
            if($this->permitido){
                ...
                if($tabla_usuarios->find($id_usuario) == null){
                    ...
                    return $this->crear_vista("panel/perfil_detalles", $this->cargar_datos($id_usuario));
        ...
        private function cargar_datos($id_usuario = NULL){
            ...
            $datos['nombre_pagina'] = 'Detalles del perfil del usuario: '.$usuario->nombre_usuario;
        ...
        private function crear_vista($nombre_vista, $contenido = array()){
            $contenido['menu'] = crear_menu_panel(TAREA_PERFIL_DETALLES, '');
