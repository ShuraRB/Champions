<?php
    ...
    class Tabla_producto extends Model {
        ...
        public function data_table_producto($tipo_categoria = 0) {
            $resultado = $this
                    ->select('
                                estatus_producto, id_producto, marca, modelo, color, tamaño,
        ...
        public function producto_limit($limit) {
            $resultado = $this
                ->select('
                            estatus_producto, id_producto, marca, modelo, color, tamaño,
                            tipo, precio, imagen_producto, destacado, descripcion
        ...
        public function producto_actuales($fecha ='0000-00-00',$limit = 0) {
            $resultado = $this
                ->select('
                            estatus_producto, id_producto, marca, modelo, color, tamaño,
                            tipo, precio, imagen_producto, destacado, descripcion
    ...
    //     public function oferta_producto($id_categoria = 0, $limit = 0){
    //         $resultado = $this
    //                     ->select('
